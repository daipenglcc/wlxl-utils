...
export { companyStatus, dDegree, dExpe, dGender, firmProperty, firmSize, format, getLocal, getSession, getTimestamp, getUrlVal, gtResults, industry, isArray, isEmpty, isNumber, jobNature, jobStatus, jobType, makeChNumber, makeChTime, makeDuration, parseUrlValToJson, random, randomWord, removeLocal, removeSession, setLocal, setSession, stanDardData };
